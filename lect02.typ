...
+ $R slash Rad(R)$ -- тело. На самом деле это критерий локальности. #comment[Надо либо добавить объяснение, либо удостовериться у Семёнова, что это идёт без доказательства]
...
#theorem[
  Если проективное накрытие существует, то оно единственно.
]
#proof[
...
#comment[в следующую теорему не вдумывался, но вроде норм]
#theorem[
...
#proof[
  ...
  Примем без доказательства, что $"End"(P_A)$ -- лоакльное кольцо. #comment[Лев написал почему так, но оказывается у меня в конспекте б/д относится к словам "главный неразложимый", короче потом надо чекнуть.]
